...
3. Another window should pop up asking for a username and password. Enter **CWLusername.zool@<!-- -->app** for your username, and your normal CWL password. Note you will only be able to login once you have been granted access to the Zoology server. Email the [Zoology Computing Unit](https://zcu.zoology.ubc.ca:442/wiki/index.php/Main_Page) in order to do so.
