...
*This section on lab philosophy and code of conduct is taken almost entirely verbatim from [The Faylab Lab Manual](https://thefaylab.github.io/lab-manual/), because it resonated so fully with me. It is to be revisited with Gaynor Lab as it grows*
...
We [care personally while also challenging directly](https://www.radicalcandor.com/). Be honest when communicating, accept critical (but kind) feedback, and give the same to others. View relationships within the group as collaborative rather than evaluative. Don’t take constructive criticism personally.  
...
Lab members who believe they have been subjected to any kind of discrimination that conflicts with the University of British Columbia's policies and/or the laws of the Province of British Columbia should seek assistance from a supervisor or an HR representative. *Link to policies here*
