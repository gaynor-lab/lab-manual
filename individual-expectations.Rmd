...
For graduate students, we will use lab funds (GRAs) to top up salaries or replace TA-ing when possible, based on availability and satisfactory progress towards degree. Lab funds should be considered a last resort, after fellowships or other funding opportunities have been exhausted. If you are funded from lab grants and contracts, you may need to be flexible in your research and adjust the topic to better align with the current grants/contracts that we have in the lab.

Tuition is the student’s responsibility and it is not part of any funding package to pay tuition from lab research funds. The Gaynor Lab will have a minimum salary that is higher than the departmental minimums, to accommodate tuition costs. 
