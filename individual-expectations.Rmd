...
The Zoology minimum graduate student stipend is \$33,000 annually for PhD students, and \$30,000 for MSc students (for 2026-2027). The funds to support this stipend do not come from the department, and the stipend is comprised of a combination of TA-ships, fellowships, and GRAs. The exact breakdown will vary by student. This minimum stipend will apply to all students in the lab, regardless of home department (unless the home department has a higher minimum, although as of now, that is not the case for any lab members). For PhD students in the Faculty of Science, tuition will be waived for 4 years, and the lab will pay tuition in year 5 if not paid by a fellowship (e.g., 4YF). For MSc students in the lab, tuition will be covered in years 1 and 2 (through a combination of Faculty of Science, Zoology, and lab funds). Any PhD students in years 6+ or MSc students in years 3+ will be responsibile for paying their own tuition out of their stipend (unless paid by a fellowship). Please note that students in most departments are also expected to pay [student fees](https://students.ubc.ca/enrolment/finances/tuition-fees), which are paid out of the stipend in all years.

Note that the minimum UBC funding package for PhD students is now $40,000, inclusive of stipend, tuition, and other awards. All lab funding packages will generally exceed this amount under the conditions outlined above. There is no university-wide minimum funding package for MSc students.

**Fellowships, grants, and other research funding**: All lab members are expected to seek and apply for extramural funding to support their work. This includes scholarships, fellowships, and research contracts to go towards their $33,000 stipend (e.g., 4YF, NSERC), but also smaller grants for travel, workshop attendance, or research costs. As a general rule, all graduate students should apply for at least one grant or fellowship every year. In most cases, obtaining a fellowship will not increase the overall take-home pay for the student, but may reduce the need to TA (see details below), and will free up lab funds to support student research, travel, and conference attendance.

**TA-ships**: Graduate students are expected to TA for two terms each year, by default. If a student has fellowship support >$15,000, they are expected to TA for at least one term. Students with fellowship(s) totaling over $33,000 may choose whether or not to TA, with all TA funding going to them.
...
The lab observes all UBC statutory holidays. Lab meetings or individual meetings that fall on these days are cancelled.

Graduate students may take 15 weekdays of vacation, as per [UBC policy](https://www.grad.ubc.ca/current-students/managing-your-program/graduate-student-vacation-policy). You are highly encouraged to take your vacation time, and are not expected to be engaged in research or in communication with the lab while you are on vacation. Please ensure that you set up out-of-office notifications on e-mail.

There is no formal system for tracking vacation, but you should let Kaitlyn know when you will be out of the office for longer than 1 day, and record these absences in the lab [Days Away](https://docs.google.com/spreadsheets/d/1q25MHybKVhlRwdPOQZ9X3AntUzTx8GPX_87hKyWkhMU/edit?gid=0#gid=0) spreadsheet. When possible, try to align your vacations with university holiday periods (this may be necessary if you are taking or teaching courses).

Medical and Parental leave will be arranged with the help of department administrators. Lab members are expected to notify Kaitlyn as early as possible to enable appropriate project management during absences.


## Work expectations for undergraduates

All undergraduate employees in the lab are expected to complete the work hours corresponding to their position (e.g., 10 hours/week for Work-Learn positions during winter terms, 20 hours/week for Work-Learn positions during summer terms, and 35 hours/week for summer WLIURA and NSERC USRA). For part-time employees, it is acceptable to make occasional adjustments, but you should communicate with your supervisor (e.g., graduate student or postdoc) about any changes to your schedule, and make sure that you are putting in the total hours for which you were hired over the course of the term (e.g., 150 or 300 hours for Work-Learn positions). For full-time summer employees, you wish to take vacation or days off that are not your typical days off, these should be communicated well in advance to your supervisor, and you should set up out-of-office notifications on Slack.

You will be expected to work at least some of your work hours **in person**, in the lab. This will be communicated at the start of your work term, and will vary by position, experience in the lab, and type of work. 

There will be **regular check-in meetings** scheduled with your supervisor(s) and/or research team, and you are expected to attend these meetings in person unless otherwise arranged. If something comes up and you are unable to attend a scheduled meeting, please provide as much notice as possible.

You are expected to maintain an up-to-date [hours tracking sheet](https://docs.google.com/spreadsheets/d/1wd4DadlbFxs_hrmIfySjMsbjggqjaFRZuUZoKYtF1z0/edit?usp=sharing) and lab journal, to be shared with your direct supervisor(s). These documents are meant to help us manage your task assignments and workload, and create a record of your work for future reference. 

### Expectations for hours tracking

+ Update your hours plan at the start of the week, so that your supervisors know when to expect you to be working.
+ Update hours tracking spreadsheet each time you work, if your worked hours differ from plans. This prevents you from having to estimate your hours later when submitting your time. 
+ Include general tasks completed in the tasks column. Keep this task column clear and concise, so that a supervisor could understand the tasks completed based on hour tracking spreadsheets alone, without needing to go to your lab journal to cross-reference. 

### Expectations for lab journals

Your lab journal should be a Google Doc shared with your supervisor(s). Each time you work, update the journal with notes about your tasks and progress.

+ Include the date for each entry, so journal is easy to follow chronologically.
+ Update lab journal each time you work.
+ Lab journal should include details about:
  + Ongoing and future tasks
    + It is helpful to keep track of where you left off in a task so it is easier to pick up from the same point next time you work. 
  + Important meeting notes
  + Procedural changes
  + Deadlines
  + Any general questions and comments for yourself or others
    + If something is non-urgent and you want to keep it in mind for an upcoming meeting, the lab journal is a good place to record it. 
  + Any decisions you made
    + For example: “I was planning to work on transferring data from a lab hard drive, but was unable to locate it, so I worked on annotating species in TrapTagger. Note: Ask supervisor where the hard drive is.”
+ When learning a new task (e.g., how to upload to TrapTagger), it is helpful to make step-by-step instructions for yourself that you can reference later or share with others. 
+ Document your thought process, especially when working through complex task.
  + Try to document things in whatever format works best for you, but keep in mind that detailed notes can be very helpful when returning to a task or issue after some time. Good documentation can prevent you from having to spend time figuring out the same problem again. 
