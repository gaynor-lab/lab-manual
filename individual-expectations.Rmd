...
Kaitlyn aims to provide financial support for lab members to attend and present at conferences annually, dependent on the availability of funding. All lab members are expected to seek external conference travel funding as well, so that the lab funds can go further.

### Authorship policy

In our collaborative work, the person who makes significant intellectual contributions (in terms of conceiving the original idea, method development, experiment design, analysis) or contributes more than 50% to the written manuscript will be the first author.
...
It is likely that Kaitlyn will be the last (senior) author on most publications led by lab members for research that is primarily conducted while you are in the lab. However, like all co-authors, Kaitlyn should earn this authorship position! For papers on which you are the first author and Kaitlyn is last author, the two of you should plan to make collective decisions about the authorship of others.
...
The Zoology minimum graduate student stipend is $30,000 annually (including tuition and student fees). This minimum stipend will apply to all students in the lab, regardless of home department (unless the home department has a higher minimum, although as of now, that is not the case for any lab members). In the Gaynor Lab, graduate students can expect a stipend of $30,000 PLUS tuition for 5 years of a PhD and 2 years of a MSc, contingent on availability of lab research funds to cover tuition, and satisfactory degree progress.

**Fellowships**: All lab members are encouraged to seek and apply for extramural funding to support their work. This includes scholarships and fellowships to pay for salary, but also smaller grants for travel, workshop attendance, or research costs. As a general rule, all graduate students should apply for at least one grant or fellowship every year. 

**TA-ships**: Graduate students are expected to TA for two terms each year, unless they have fellowship support >$15,000, in which case they are expected to TA for at least one term. Students with fellowship(s) totaling over $30,000 may choose whether or not to TA, with all TA funding going to them.

**GRAs**: We will use lab funds (GRAs) to bring take-home salaries to $30,000, so long as a student is making satisfactory progress towards degree. Lab funds should be considered a last resort, after fellowships, TAships, and other funding opportunities have been exhausted. If you are funded from lab grants and contracts, you may need to be flexible in your research and adjust the topic to better align with the current grants/contracts that we have in the lab.
