...
The story is a bit different for writing and organizing your ideas. LLMs really stifle the creative process, and thinking about the best way to structure a paper or paragraph is how you develop new ideas and insights. ChatGPT also reinforces certain worldviews and dominant paradigms, and can constrain your thinking. It also can’t come up with original ideas, which is the whole point of our work. And then later in the writing process, if you use ChatGPT to refine your language once the ideas are all in place, it just makes you sound like a robot and takes away your voice. Therefore, LLMs should not be used to draft abstracts, manuscripts, or other technical writing products without consulting Kaitlyn. You should not be feeding data or scientific writing into an LLM. For writing, you should only use LLMs at the level of a decent spellcheck or thesaurus, but not to autocomplete sentence or revise writing beyond basic grammar. If you are ever in doubt about whether you are using an LLM in a way that is appropriate for your work here, please discuss with Kaitlyn.
